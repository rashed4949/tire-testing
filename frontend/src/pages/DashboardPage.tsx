  ...
  return (
      <Box>
        ...
        <Typography variant="body2" color="text.secondary" mb={3}>
          Here's what's happening in tire testing lab today.
        </Typography>
            ...
            <Card sx={{ height: '100%' }}>
              <CardContent>
                ...
                {[
                  ...
                  { label: 'Active Sessions', value: stats.totalSessions > 0 ? (stats.activeSessions / stats.totalSessions) * 100 : 0, color: '#FFD100' },
